...
def add_discriminator_block(old_model, n_input_layers=3, lr=10e-5, b_1=0.0, b_2=0.99, eps=10e-8):
  ...
  # compile model
  model1.compile(loss=cramer_loss, optimizer=Adam(lr=lr, beta_1=b_1, beta_2=b_2, epsilon=eps))
  ...
  # compile model
  model2.compile(loss=cramer_loss, optimizer=Adam(lr=lr, beta_1=b_1, beta_2=b_2, epsilon=eps))
...
def define_discriminator(n_blocks, lr=10e-5, b_1=0.0, b_2=0.99, eps=10e-8, input_shape=(4,4,3)):
  ...
  # compile model
  model.compile(loss=cramer_loss, optimizer=Adam(lr=lr, beta_1=b_1, beta_2=b_2, epsilon=eps))
  # store model
